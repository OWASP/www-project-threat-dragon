...
The environment variables will need configuration so there is a [step-by-step guide](/docs/version-1.x/set-up/) to help with this.
...
so there is a [step-by-step guide](/docs/version-1.x/set-up/) to help with this. 
