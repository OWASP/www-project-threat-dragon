...
* Single page [web application](https://github.com/OWASP/threat-dragon/releases/tag/v2.2.0)
* Docker [image](https://hub.docker.com/r/owasp/threat-dragon/tags?page=1&ordering=name)
* Desktop installers for:
* [Linux / MacOS / Windows](https://github.com/OWASP/threat-dragon/releases/tag/v2.2.0)
